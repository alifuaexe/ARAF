...
// $Rev: 52393 $
// File generated on 19.11.2016 10:44:50 from Type Library described below.

// ************************************************************************  //
// Type Lib: \\192.168.1.197\d$\Logo\GO 3\LOBJECTS.exe (1)
...
// *********************************************************************//
  ILines = interface(ICollection)
    ...
    function GetStockLinePrice(prcTyp: Smallint; out price: Double): SYSINT; safecall;
...
// *********************************************************************//
  ILinesDisp = dispinterface
    ...
    function GetStockLinePrice(prcTyp: Smallint; out price: Double): SYSINT; dispid 4;
...
// *********************************************************************//
  IProductionApplication = interface(IDispatch)
    ...
    function ChangeProdOrdBegAndEndPer(const ficheNo: WideString; begDate: Integer; 
                                       begTime: Integer; endDate: Integer; endTime: Integer; 
                                       dueDate: Integer; dueTime: Integer): WordBool; safecall;
    ...
    function AddDispLines(const ficheNo: WideString; const DispLines: IPrdDispLines): WordBool; safecall;
    ...
    function AddStopTransForAWOrd(wOrdRef: Integer; StpCRef: Integer; StpDate: Integer; 
                                  StpTime: Integer; StartDate: Integer; StartTime: Integer): WordBool; safecall;
...
// *********************************************************************//
  IProductionApplicationDisp = dispinterface
    ...
    function ChangeProdOrdBegAndEndPer(const ficheNo: WideString; begDate: Integer; 
                                       begTime: Integer; endDate: Integer; endTime: Integer; 
                                       dueDate: Integer; dueTime: Integer): WordBool; dispid 9;
    ...
    function AddDispLines(const ficheNo: WideString; const DispLines: IPrdDispLines): WordBool; dispid 12;
    function FastRealizeFicheGenerateForWOrder(wOrdRef: Integer; ItemRef: Integer; 
                                               prodAmnt: Double; uomRef: Integer; method: Integer; 
                                               removeSidePrdct: WordBool; 
                                               const SlipLists: IFastRealizeSlipRefLists; 
    ...
    function AddStopTransForAWOrd(wOrdRef: Integer; StpCRef: Integer; StpDate: Integer; 
                                  StpTime: Integer; StartDate: Integer; StartTime: Integer): WordBool; dispid 26;
    function RealizeFicheAnalyse(prodOrdRef: Integer; const ficheInfos: IRealizedSlips; 
                                 amount: Double; isPerc: WordBool; vrntRef: Integer; 
