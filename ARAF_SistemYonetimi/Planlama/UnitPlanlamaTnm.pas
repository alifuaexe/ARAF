...
uses
  ...
  cxSplitter,UnitAnaMenu, ElastFrm;

type
  TFormPlanlamaTnm = class(TFormBasic)
...
var
  FormPlanlamaTnm: TFormPlanlamaTnm;

implementation

{$R *.dfm}
 uses Units, Sec;
procedure TFormPlanlamaTnm.BtnDegistirClick(Sender: TObject);
begin
  inherited;
...
procedure TFormPlanlamaTnm.BtnKaydetClick(Sender: TObject);
var
  xAdoQuery : TADOQuery;
begin
inherited;
...
procedure TFormPlanlamaTnm.BtnSilClick(Sender: TObject);
var ID:string;
begin
inherited;
...
function TFormPlanlamaTnm.UrunHareketKontrol(STOKID:integer):Boolean;
var
  xAdoQuery : TADOQuery;
  kontrol:Boolean;
begin
...
procedure TFormPlanlamaTnm.BtnYeniClick(Sender: TObject);
begin
  inherited;
edtKeyid.Text       := '';
edtUrunKodu.Text    := '';
...
procedure TFormPlanlamaTnm.cxButtonEdit1PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
  var SqlStr: string;
begin
...
procedure TFormPlanlamaTnm.Listele;
var
SqlWhere:string;
begin
...
procedure TFormPlanlamaTnm.edtFabrikaIDPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var SqlStr: string;
begin
...
procedure TFormPlanlamaTnm.edtUrunAdiAraKeyDown(Sender: TObject;
...
procedure TFormPlanlamaTnm.edtUrunKoduAraKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
if Key<>vk_Return then exit;
...
procedure TFormPlanlamaTnm.edtUrunTipiPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var SqlStr: string;
begin
  case AButtonIndex of
...
procedure TFormPlanlamaTnm.FormClose(Sender: TObject;
...
procedure TFormPlanlamaTnm.FormCreate(Sender: TObject);
begin
  MasterTblName  := 'ITEMS';
...
procedure TFormPlanlamaTnm.FormShow(Sender: TObject);
var
SqlWhere :String;
begin
  inherited;
...
procedure TFormPlanlamaTnm.gridViewCellDblClick(
