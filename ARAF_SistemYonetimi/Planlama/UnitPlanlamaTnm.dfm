inherited FormPlanlamaTnm: TFormPlanlamaTnm
    ...
    inherited PageDetay: TcxTabSheet
      ...
      inherited Panel4: TPanel
        ...
        inherited Panel3: TPanel
          ...
          object edtUrunKodu: TcxTextEdit
            Left = 140
            Top = 43
            AutoSize = False
            TabOrder = 1
          ...
          object edtUrunTipi: TcxButtonEdit
            Left = 140
            Top = 115
            Properties.Buttons = <
              item
            ...
            Properties.OnButtonClick = edtUrunTipiPropertiesButtonClick
            TabOrder = 4
            Width = 273
          end
          object edtBirimID: TcxLookupComboBox
            Left = 140
            Top = 139
            AutoSize = False
            Properties.KeyFieldNames = 'UNIT_ID'
            Properties.ListColumns = <
              item
                FieldName = 'UNIT_NAME'
              end>
            Properties.ListSource = DataSourceBirim
            TabOrder = 5
            Height = 24
            Width = 273
          end
          object edtERPKodu: TcxTextEdit
            Left = 140
            Top = 163
            AutoSize = False
            TabOrder = 6
        ...
        inherited Panel5: TPanel
          ...
          inherited cxGrid1: TcxGrid
            ...
            inherited gridView: TcxGridDBTableView
              ...
              object gridViewITEM_CODE: TcxGridDBColumn
                Caption = 'Kodu'
              ...
              object gridViewUNIT: TcxGridDBColumn
                Caption = 'Birim'
              ...
              object gridViewERP_ID: TcxGridDBColumn
                Caption = 'Erp Id'
                DataBinding.FieldName = 'ERP_ID'
                Width = 54
              end
              object gridViewTYPE: TcxGridDBColumn
                Caption = 'Tip'
  ...
  inherited ADOQuery1: TADOQuery
    CursorType = ctStatic
    SQL.Strings = (
      'select top 1  * from ARF_ITEMS_LIST')
    Left = 794
    Top = 108
    object ADOQuery1ITEM_ID: TIntegerField
      FieldName = 'ITEM_ID'
    end
    object ADOQuery1ITEM_CODE: TWideStringField
      FieldName = 'ITEM_CODE'
      Size = 50
    end
    object ADOQuery1ITEM_NAME: TWideStringField
      FieldName = 'ITEM_NAME'
      Size = 50
    end
    object ADOQuery1STATUS: TFloatField
      FieldName = 'STATUS'
    end
    object ADOQuery1ERP_ID: TIntegerField
      FieldName = 'ERP_ID'
    end
    ...
    object ADOQuery1ITEM_GRP_ID: TIntegerField
    ...
    object ADOQuery1UNIT: TIntegerField
      FieldName = 'UNIT'
    end
  end
  ...
  inherited ElasticForm1: TElasticForm
    DesignFormWidth = 951
    DesignFormHeight = 667
    DesignFormClientWidth = 935
    DesignFormClientHeight = 628
  end
  object ADOQueryBirim: TADOQuery
    ...
    Left = 794
    Top = 164
    object ADOQueryBirimUNIT_ID: TAutoIncField
      FieldName = 'UNIT_ID'
      ReadOnly = True
    end
    object ADOQueryBirimUNIT_NAME: TWideStringField
      FieldName = 'UNIT_NAME'
      Size = 10
    end
    object ADOQueryBirimEXPLANATION: TWideStringField
      FieldName = 'EXPLANATION'
      Size = 50
    end
  end
