...
begin
  ...
  begin
    ShowMessage('Server adý girilmelidir.');
  ...
  begin
    ShowMessage('Veritabaný adý girilmelidir.');
  ...
  begin
    ShowMessage('Kullanýcý adý girilmelidir.');
  ...
  begin
    ShowMessage('Kullanýcý þifresi girilmelidir.');
