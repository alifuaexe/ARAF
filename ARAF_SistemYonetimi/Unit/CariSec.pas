...
type
  TfrmCariSec = class(TForm)
    ...
    qryListe: TADOQuery;
    dsListe: TDataSource;
    qryListeKEYID: TIntegerField;
    qryListeTIP_ADI: TWideStringField;
    qryListeTIP_KODU: TWideStringField;
    gridDBTableView1KEYID: TcxGridDBColumn;
    gridDBTableView1TIP_ADI: TcxGridDBColumn;
    gridDBTableView1TIP_KODU: TcxGridDBColumn;
...
procedure TfrmCariSec.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfrmCariSec.gridDBTableView1DblClick(Sender: TObject);
begin
  if btnsec.Enabled = True then btnSecClick(Self);
end;

procedure TfrmCariSec.gridDBTableView1KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then gridDBTableView1DblClick(Self);
end;

procedure TfrmCariSec.FormShow(Sender: TObject);
var  formname:string;
begin
...
procedure TfrmCariSec.FormCloseQuery(Sender: TObject;
